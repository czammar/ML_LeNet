...
LeNet-5 es una red convolucionar diseñada para reconocimiento de caracteres escritos a mano y a maquina. 
...
\begin{itemize}
	\item \textbf{1a capa:} consta de 6 filtros de tamaño 5 X 5 y un paso de 1.
	
	\item \textbf{2a capa:} capa de "sub-sampling" o de agrupación promedio de tamaño 2 X 2 y un paso de 2.
	
	\item \textbf{3a capa:} capa convolucional que consta de 16 filtros de tamaño 5 X 5 y un paso de 1.
	
	\item \textbf{4a capa:} es nuevamente una capa de agrupación promedio de tamaño 2 X 2 y de 2 paso.
	
	\item \textbf{5a capa:} conecta la salida de la cuarta capa (400 parámetros) a una capa completamente conectada de 120 nodos.
	
	\item \textbf{6a capa:} una capa igualmente completamente conectada que consta de 84 nodos, que se derivan de las salidas de los 120 nodos de la quinta capa.
