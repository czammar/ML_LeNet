...
\frametitle{Arquitectura LeNet-5}
\begin{itemize}
	\item \textbf{1a capa:} consta de 6 filtros de tamaño 5 X 5 y un stride de 1.
	...
	\item \textbf{3a capa:} capa convolucional que consta de 16 filtros de tamaño 5 X 5 y un stride de 1.
